...
import { TextInputProps, TextInputAbstract, DomBuilder } from '@aws/mynah-ui';
...
export const MynahUITextInput = (props: MynahUITextInputProps) => {
...
export class CloudscapeMynahUITextInput extends TextInputAbstract {
    ...
    constructor(props: TextInputProps) {
        ...
        this.render = DomBuilder.getInstance().build({
            type: 'span',
            classNames: ['mynah-ui-cloudscape-text-input-wrapper', 'mynah-form-input-wrapper', ...(this.props.classNames ?? [])],
    ...
    private readonly updateRender = () => {
        this.root.render(<MynahUITextInput {...this.props} onChange={this.onChangeHandler} disabled={this.disabled} />);
    };
