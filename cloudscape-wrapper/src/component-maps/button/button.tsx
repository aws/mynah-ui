...
export const MynahUIButton = (props: MynahUIButtonProps): JSX.Element => {
  const getElmList = (): Array<string | ExtendedHTMLElement | HTMLElement> => [
...
export class CloudscapeMynahUIButton extends ButtonAbstract {
  ...
  constructor(props: ButtonProps) {
    ...
    this.render = DomBuilder.getInstance().build({
      type: 'span',
      classNames: [
        'mynah-ui-cloudscape-button-wrapper',
        ...(props.primary === false
          ? ['mynah-ui-cloudscape-button-inline']
          : []),
    ...
    this.root.render(
      <MynahUIButton {...this.props} disabled={this.disabled} />
    );
  }
